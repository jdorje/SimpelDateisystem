...
ACLOCAL = ${SHELL} /ilab/users/jdc211/416/SimpelDateisystem/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /ilab/users/jdc211/416/SimpelDateisystem/missing autoconf
AUTOHEADER = ${SHELL} /ilab/users/jdc211/416/SimpelDateisystem/missing autoheader
AUTOMAKE = ${SHELL} /ilab/users/jdc211/416/SimpelDateisystem/missing automake-1.14
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /ilab/users/jdc211/416/SimpelDateisystem/missing makeinfo
...
STRIP = 
VERSION = 2014-06-12
abs_builddir = /ilab/users/jdc211/416/SimpelDateisystem
abs_srcdir = /ilab/users/jdc211/416/SimpelDateisystem
abs_top_builddir = /ilab/users/jdc211/416/SimpelDateisystem
abs_top_srcdir = /ilab/users/jdc211/416/SimpelDateisystem
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /ilab/users/jdc211/416/SimpelDateisystem/install-sh
